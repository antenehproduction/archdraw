...
window.ZONING_MATRIX_DB = {
  ...
  'redmond,wa:NR': {
    ...
    sb9Eligible: false,
    notes: 'DISTRICT RENAME: Ord 3186 (adopted 2024-11-19, eff. 2025-01-01) repealed R-4, R-6, R-8 and 8 other residential codes; consolidated into NR + NMF. NR is a single envelope citywide — no lot-size tiering. Lot coverage 60% confirmed (RZC 21.08.143B.4); setbacks/height/stories live in Table 21.08.143B.3, which is Cloudflare-Turnstile-blocked on both redmond.municipal.codes and redmond.gov. Side-yard sharing rule (RZC 21.08.143): min 3ft per side, 6ft total between structures on abutting lots. ADU: aduMaxSqFt field carries the conservative 1,000 sf DADU cap (matches WA HB 1337 floor); RZC 21.08.220 allows AADU (attached ADU) up to 1,500 sf. Light-rail major-transit stations for HB 1110 0.25mi bonus: Overlake Village + Redmond Technology (opened 2024-04-27) and Downtown Redmond (opened 2025); citywide 6-du baseline subsumes the transit bonus in practice. WA HB 1337 (eff. 2025-07-01): 2 ADUs/lot, no owner-occ, no ADU parking, min ADU 1,000 sf — Ord 3186 amended RZC 21.08.220 to align; detached ADU may abut alley/ROW lot line. WA SB 5184 (May 2025): caps multifamily parking at 0.5/unit; Redmond already eliminated minimums Jan 2025; codification deadline 2027-01-27. URBAN CENTERS — DO NOT USE NR FOR: Overlake (RZC Ch. 21.12, OV-1..OV-7, towers up to 200+ft); Downtown (RZC Ch. 21.10, DT zones); Marymoor Village (RZC Ch. 21.13). Parcels inside those overlays use independent zone codes.',
    verifiedDate: '2026-04-24',
